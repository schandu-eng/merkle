...
const Home: React.FC = () => {
  ...
  Saurav's Calendar
        ...
        <button
          ...
          style={isDarkMode ? { background: "#262626" } : {background: "#FDE68A"}}
        >
          List
        </button>
        <button
  ...
  <Dialog
    open={open}
    onClose={handleClose}
    className="fixed inset-0 z-50 overflow-auto bg-opacity-70 backdrop-blur-sm"
    sx={{
      "& .MuiDialog-paper": {
  ...
  >
    Today
      ...
      >
        ...
        style={isDarkMode ? { background: "#161616" } : {background:"#262626"}}
            >
             ...
             <button
              ...
              className={`p-2 font-light text-[9px] sm:text-[11px] md:text-[13px] lg:text-sm xl:text-[16px] ${
                nextType === 'month' ? (
                  ...
                  isDarkMode ? "text-white" : "bg-gray-300 text-gray-900"
                )
            ...
            <button
              ...
              className={`p-2 ml-2 font-light text-[9px] sm:text-[11px] md:text-[13px] lg:text-sm xl:text-[16px] ${
                nextType === 'year' ? (
                  ...
                  isDarkMode ? "bg-white text-white" : "bg-gray-300 text-gray-900"
                )
              } rounded-full transition duration-300 ${selectedYear === 2030 ? 'cursor-not-allowed' : ''}`}
              
              style={isDarkMode && nextType!=="year" ? { background: "#161616" } : {background: ""}}
            >
              Year
            </button>
          </div>
